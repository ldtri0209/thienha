		...
		<div class="row home_portfolio_row">
			<div class="col-md-6 col-sm-6 qua_col_padding">
					...
					<div class="qua_home_portfolio_showcase_overlay">
						<div class="qua_home_portfolio_showcase_overlay_inner">
							<div class="qua_home_portfolio_showcase_icons">
								<a href="<?php echo $current_options['project_one_thumb']; ?>" data-lightbox="image" title="<?php echo $current_options['project_one_title']; ?>" class="hover_thumb"><i class="fa fa-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="qua_home_portfolio_caption">
					<a href="http://thienhafurniture.com/products/water-hyacinth-furniture/"><?php echo $current_options['project_one_title']; ?></a>
					<span style="float: right;font-weight: 600;"><a href="http://thienhafurniture.com/products/poly-rattan-furniture/">View Detail</a></span>
				</div>
				<?php } ?>
			</div>
			<div class="col-md-6 col-sm-6 qua_col_padding">
				...
				<div class="qua_portfolio_image">
					...
					<div class="qua_home_portfolio_showcase_overlay">
						<div class="qua_home_portfolio_showcase_overlay_inner">
							<div class="qua_home_portfolio_showcase_icons">
								<a href="<?php echo $current_options['project_two_thumb']; ?>" data-lightbox="image" title="<?php echo $current_options['project_one_title']; ?>" class="hover_thumb"><i class="fa fa-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="qua_home_portfolio_caption">
					<a href="http://thienhafurniture.com/products/poly-rattan-furniture/"><?php echo $current_options['project_two_title']; ?></a>
					<span style="float: right;font-weight: 600;"><a href="http://thienhafurniture.com/products/poly-rattan-furniture/">View Detail</a></span>
				</div>
				<?php } ?>
			</div>
...
<!--			</div>-->
			...
			<a href="http://thienhafurniture.com/products/"> View More Products </a>
			</div>			
		</div>
	</div>
</div>