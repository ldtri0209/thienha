		...
		<div class="row home_portfolio_row">
			<div class="col-md-6 col-sm-6 qua_col_padding">
				...
				<div class="qua_home_portfolio_caption">
					<a href="http://thienha.me/products/water-hyacinth-furniture/"><?php echo $current_options['project_one_title']; ?></a>
			...
			<div class="col-md-6 col-sm-6 qua_col_padding">
				...
				<div class="qua_home_portfolio_caption">
					<a href="http://thienha.me/products/poly-rattan-furniture/"><?php echo $current_options['project_two_title']; ?></a>
					<span style="float: right;font-weight: 600;">View Detail</span>
				</div>
				<?php } ?>
			</div>
...
<!--			</div>-->
			...
			<a href="http://thienha.me/products/"> View More Products </a>
			</div>			
		</div>
	</div>
</div>