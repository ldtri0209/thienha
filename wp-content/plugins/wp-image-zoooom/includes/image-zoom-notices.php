...
class ImageZoooom_Notices {
    ...
    public function get_message( $notice ) {
        ...
        if ( $notice == '12_days' ) {
            $link = 'http://www.silkypress.com/wp-image-zoooom-pro-offer/';
        } else {
            $link = 'http://www.silkypress.com/wp-image-zoooom-pro-special-offer/?a=' . $this->convert_numbers_letters( $this->activation_time );
        }
